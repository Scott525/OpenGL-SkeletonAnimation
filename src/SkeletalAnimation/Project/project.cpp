...
#include <tool/animator.h>
#include <tool/model_animation.h>
...
int main()
{
	...
	// -------------------------
	Shader stageShader("model_loading_vertex.glsl", "model_loading_fragment.glsl");
	Shader characterShader("anim_model_vs.glsl", "anim_model_fs.glsl");
    ...
    {
        "../../resources/skybox/TropicalSunnyDay_px.jpg",
        "../../resources/skybox/TropicalSunnyDay_nx.jpg",
        "../../resources/skybox/TropicalSunnyDay_py.jpg",
        "../../resources/skybox/TropicalSunnyDay_ny.jpg",
        "../../resources/skybox/TropicalSunnyDay_pz.jpg",
        "../../resources/skybox/TropicalSunnyDay_nz.jpg"
    };
    unsigned int cubemapTexture = loadCubemap(skybox);
	...
	SoundEngine->play2D("../../resources/audio/Perfume.wav", true);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		stageShader.setVec3("pointLight.position", glm::vec3(0.0f, 1.0f, 1.0f));
		stageShader.setVec3("pointLight.ambient", glm::vec3(0.5f));
		stageShader.setVec3("pointLight.diffuse", glm::vec3(0.8f)); // 将光照调暗了一些以搭配场景
		stageShader.setVec3("pointLight.specular", glm::vec3(0.4f));
		stageShader.setFloat("pointLight.constant", 1.0f);
		stageShader.setFloat("pointLight.linear", 0.09f);
		stageShader.setFloat("pointLight.quadratic", 0.032f);
		...
		characterModel.Draw(characterShader);
